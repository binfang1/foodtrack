    ...
    return (
        <div className="relative h-[100vh] w-[85vw] bg-white h-full drop-shadow-md rounded-xl border-solid border-3 border-[#D9D9D9]">
            ...
            <div className="p-[0.8vw] h-[100vh] flex flex-col bg-white rounded-xl" >
                ...
                <button onClick = {() => change()} className="mt-auto mb-[1.5vw] cursor-pointer bg-white rounded-xl border-solid border-3 border-[#D9D9D9] text-black rounded-lg shadow-md h-[3vw] text-[0.9vw]">Add New Account</button>
            </div>
            }
            {page ? (
                <div>
